(function (window) {
    ...
    opspark.preload = function (game) {
        ...
        game.load.image('Mbappe', './asset/collectable/Mbappe.png');
        game.load.image('Crown', './asset/collectable/Crown.png');
        game.load.image('ronaldo', './asset/collectable/ronaldo.png');
        game.load.image('messi', './asset/collectable/messi.png');
